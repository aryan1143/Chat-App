        ...
        {messages &&
          ...
          messages.toReversed().map((message) => {
            return message.receiverId === authUser._id ? (
              <div key={message._id} className="mr-auto flex gap-1 w-fit h-fit my-1 lg:my-2 text-2sm">
                ...
                <div className="flex flex-col">
                  <p className="text-xs ml-2">{formatMessageTime(message.createdAt)}</p>
              ...
              <div key={message._id} className="ml-auto flex gap-1 w-fit h-fit my-1 lg:my-2 text-2sm">
                <div className="flex flex-col">
                  <p className="text-xs ml-auto mr-2">{formatMessageTime(message.createdAt)}</p>
