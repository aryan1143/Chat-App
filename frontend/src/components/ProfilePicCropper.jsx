    ...
    return (
        <div className="flex flex-col items-center gap-4">
            ...
            {!imageSrc && isUpdatingProfile ?
                ...
                (
                    <label htmlFor='profilePic' className='cursor-pointer absolute flex gap-1 p-1 px-2 bg-primary text-primary-content rounded-xl -bottom-3 left-[50%] translate-x-[-50%]'>
                        <Camera />
                        <p>Edit</p>
                    </label>
                )
